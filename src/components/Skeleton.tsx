...
export function SkeletonCard() {
    return (
        <div className="glass-card bg-[#0a1020]/80 border border-white/5 rounded-md p-6 space-y-4">
...
export function SkeletonTable({ rows = 5 }: { rows?: number }) {
    return (
        <div className="glass-card bg-[#0a1020]/80 border border-white/5 rounded-md overflow-hidden">
            {/* Header Row */}
        ...
        <div className="space-y-8 animate-in fade-in duration-500">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                {Array.from({ length: 4 }).map((_, i) => (
                    <div key={i} className="glass-card bg-[#0a1020]/80 border border-white/5 rounded-md p-5 space-y-3">
                        <Skeleton className="h-4 w-20 rounded-md" />
